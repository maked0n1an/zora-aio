...
with open(f'{data_folder}/{abi_folder}/{create_nft_folder}/nft_creator_abi.json') as file:
    ZORA_NFT_CREATOR_ABI = json.load(file)
...
with open(f'{data_folder}/english_words.txt', 'r') as file:
    ENGLISH_WORDS = [row.strip() for row in file]

ZORA_BRIDGE_CONTRACT            = '0x1a0ad011913A150f69f6A19DF447A0CfD9551054'
